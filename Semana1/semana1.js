...
ex1.onclick = function () {
    ...
    pInfo.innerHTML = 'Nesse exercício vamos exercitar a independência entre os 4 dedos da escala na ordem 1234. Lembre-se de alguns detalhes para uma melhor execução:<br><br><br>- Palhetada alternada <br><br><br>- Mova os dedos o mínimo possível, distanciando apenas o necessário de cada corda <br><br><br>- Use um metrônomo pra trabalhar as divisões rítmicas corretamente <br><br>(semínima --> 1 nota por tempo)<br><br>(colcheia --> duas notas por tempo)'
...
ex2.onclick = function () {
    ...
    pInfo.innerHTML = 'Aqui o objetivo é a memorização das pentas de Am em 5 posições (braço inteiro). Use os botões de navegação de posições pra uma melhor visualização de cada shape da penta. Estude cada um dos formatos separadamente.'
...
ex3.onclick = function () {
    ...
    mostrarE()
    mostrarD()
    video.src = 'https://www.youtube.com/embed/QLNGUV4vi4U'

    pInfo.innerHTML = 'Chegou a hora de juntar todos os formatos e usar a criatividade pra improvisar na base.'
    
}

ex4.onclick = function () {

    video.src = 'https://www.youtube.com/embed/3uwc8U2i4NY'
    pdf.src = 'campo.pdf'
